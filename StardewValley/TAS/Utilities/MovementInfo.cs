...
namespace TAS.Utilities
{
    public class MovementInfo
    {
        ...
        public static bool GetMovementTowardTileCenter(Vector2 playerCenter, Vector2 tileCenter, out SKeyboardState kstate)
        {
        ...
        public static bool ShouldAnimCancel(out SKeyboardState kstate)
        {
            kstate = null;
        ...
        public static bool ShouldAnimCancelWeapons(out SKeyboardState kstate)
        {
            kstate = null;
            if (!Player.Active || !Player.UsingTool)
                return false;
