...
namespace TAS.Overlays
{
    public class Sleep : IOverlay
    {
        ...
        public string MaxString = "ABCDEFGH";
        public override string[] HelpText()
        {
            return new string[] { string.Format("{0}: overlay current overnight updates", Name) };
        }
        ...
        public Sleep()
        {
            MaxRowWidth = (int)(42f * (RowHeight / 28f) + MeasureString(MaxString).X);
        ...
        {
            // compute scaling
            float scale = height / bgRect.Height;
            ...
            DrawRectFromTexture(spriteBatch, texture, bgRect, destBGRect);
            ...
            if (iconRect != null)
            {
                ...
                DrawRectFromTexture(spriteBatch, texture, (Rectangle)iconRect, destIconRect);
            }
            // draw the text
            if (text != null && text != "")
            {
                ...
                Rectangle textRect = new Rectangle((int)origin.X + width, (int)origin.Y, (int)textSize.X, height);
                // TODO: This is for some reason leading to some clipped text??
                DrawCenteredTextInRectLocal(spriteBatch, textRect, text, Color.White);
            }
        }
        ...
        public bool DrawLuckRow(SpriteBatch spriteBatch, Vector2 origin, double luck)
        {
            ...
            Vector2 offset = new Vector2(15, 13);
